...
import { buildAssumptionsTable, buildMetricRow, buildReportHeader, STYLES } from './shared';
...
export function buildCostSavingsReportDefinition(ctx: {
  ...
  return {
    content: [
      ...buildReportHeader('Cost & Savings Report', ctx.name, ctx.period, ctx.status, ctx.dateDelivered),
