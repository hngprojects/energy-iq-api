...
export class CreateAllTables1778753619163 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "onboarding_complete" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "onboarding_complete" SET DEFAULT false`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."inverters_brand_enum" AS ENUM('VICTRON', 'GROWATT', 'SUNSYNK', 'DEYE')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_28ae56bc5bbfbab9a6b3210464"`);
        await queryRunner.query(`CREATE TYPE "public"."inverters_brand_enum_old" AS ENUM('VICTRON', 'GROWATT', 'SUNSYNK')`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "onboarding_complete" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "onboarding_complete" DROP NOT NULL`);
