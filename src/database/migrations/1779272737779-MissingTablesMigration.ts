...
export class MissingTablesMigration1779272737779 implements MigrationInterface {
  name = 'MissingTablesMigration1779272737779';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Ensure enums exist (safe no-op if already present)
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "inverters" (
        ...
        "brand" "public"."inverters_brand_enum" NOT NULL,
        "model" character varying(255) NOT NULL,
        "serial_number" character varying(255) NOT NULL,
        "installation_id" character varying(255),
        "api_type" "public"."inverters_api_type_enum" NOT NULL,
        "encrypted_credentials" text,
        "is_active" boolean NOT NULL DEFAULT true,
        "is_offline" boolean NOT NULL DEFAULT false,
        "last_synced_at" TIMESTAMP WITH TIME ZONE,
        "rated_capacity_kwh" numeric(10,2) NOT NULL DEFAULT '0',
        "panel_capacity_kw" numeric(5,2) NOT NULL DEFAULT '0',
        CONSTRAINT "UQ_8dc023670abc3138875327fea42" UNIQUE ("serial_number"),
        CONSTRAINT "PK_256e52026f45115fde7fb14e2fc" PRIMARY KEY ("id")
      )
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "inverter_metrics" (
        ...
        "solar_gen_kw" numeric(10,2) NOT NULL,
        "battery_soc_percent" numeric(5,2) NOT NULL,
        "load_kw" numeric(10,2) NOT NULL,
        "grid_frequency_hz" numeric(5,2),
        "battery_voltage_v" numeric(10,2),
        "battery_current_a" numeric(10,2),
        "grid_voltage_v" numeric(10,2),
        "naira_saved_ngn" numeric(15,2) NOT NULL DEFAULT '0',
        "daily_energy_kwh" numeric(10,2),
        "raw_data" jsonb,
        "inverter_status" character varying(50),
        "battery_temperature_c" numeric(5,2),
        "battery_time_to_go_min" numeric(8,2),
        "inverter_temperature_c" numeric(5,2),
        "metric_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL,
        CONSTRAINT "PK_9859fcbfdef784c173ee75a6934" PRIMARY KEY ("id")
      )
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "daily_metrics" (
        ...
        "inverter_id" uuid NOT NULL,
        "date" date NOT NULL,
        "total_solar_energy_wh" numeric(15,2) NOT NULL DEFAULT '0',
        "total_ac_output_energy_wh" numeric(15,2) NOT NULL DEFAULT '0',
        CONSTRAINT "UQ_50f7e2d6cbbde644fcff3adf3c4" UNIQUE ("inverter_id", "date"),
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "chats" (
        ...
        "expiration_timeout_seconds" integer,
        "is_active" boolean NOT NULL DEFAULT true,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "messages" (
        ...
        "delivery_status" character varying(40) NOT NULL,
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "waitlist" (
        ...
        CONSTRAINT "UQ_2221cffeeb64bff14201bd5b3de" UNIQUE ("email"),
    ...
    await queryRunner.query(`DO $$ BEGIN
      ALTER TABLE "inverters" ADD CONSTRAINT "FK_7e7dc9572076d05e7599f5fc4ae"
        FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
    EXCEPTION WHEN duplicate_object THEN NULL; END $$`);

    await queryRunner.query(`DO $$ BEGIN
      ALTER TABLE "inverter_metrics" ADD CONSTRAINT "FK_cd66337ed18480287071464ab23"
        FOREIGN KEY ("inverter_id") REFERENCES "inverters"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
    EXCEPTION WHEN duplicate_object THEN NULL; END $$`);

    await queryRunner.query(`DO $$ BEGIN
      ALTER TABLE "daily_metrics" ADD CONSTRAINT "FK_25013b61db327b6629e194da1b1"
        FOREIGN KEY ("inverter_id") REFERENCES "inverters"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
    EXCEPTION WHEN duplicate_object THEN NULL; END $$`);

    await queryRunner.query(`DO $$ BEGIN
      ALTER TABLE "messages" ADD CONSTRAINT "FK_7540635fef1922f0b156b9ef74f"
        FOREIGN KEY ("chat_id") REFERENCES "chats"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
    EXCEPTION WHEN duplicate_object THEN NULL; END $$`);
