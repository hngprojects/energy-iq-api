...
export class UploadedImageMigrations1781728371420 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "uploaded-images" ADD CONSTRAINT "FK_66105a91f78a99b9a0468fbe98d" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "uploaded-images" DROP CONSTRAINT "FK_66105a91f78a99b9a0468fbe98d"`);
        await queryRunner.query(`DROP TABLE "reports"`);
        await queryRunner.query(`DROP TABLE "uploaded-images"`);
        await queryRunner.query(`DROP TYPE "public"."uploaded-images_upload_status_enum"`);
    }
